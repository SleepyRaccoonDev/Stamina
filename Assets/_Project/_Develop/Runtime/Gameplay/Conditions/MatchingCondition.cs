...
{
    public class MatchingCondition : IGameCondition
    {
        ...
        public MatchingCondition(Typer typer, string generatedString)
        {
            _typer = typer;
        ...
        {
            if (string.Equals(_generatedString, typedString, StringComparison.Ordinal) == true)
                Triggered?.Invoke();
        }
    }
}